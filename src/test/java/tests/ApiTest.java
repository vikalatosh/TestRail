...
public class ApiTest {
    ...
    public void testCaseShouldBeCreatedByApi() {
        ...
        TestCase testCase = TestCase.builder()
                ...
                .build();
        ResponseTestCase actualCase = new TestCaseAdapter().createTestCase(testCase, 200, actualSection.getId());
        assertEquals(actualCase.getTitle(), testCase.getTitle());
        ResponseTestCase getActualCase = new TestCaseAdapter().getTestCase(200, actualCase.getId());
